...
const BaseLayout = ({ children }) => {
  return (
    <>
      ...
      <div className="min-h-screen bg-transparent leading-normal">
        <BaseHeader />
        <main className="max-w-6xl min-h-120 p-4 m-auto md:my-4 h-full md:h-auto bg-light-parchment bg-opacity-90">
          {children}
        </main>
      </div>
    </>
